# Automatización de DynamoDB con Python y Boto3

# Configurando AWS

```
Pones los datos de tu cuenta en la configuracion.
```
...
```
![alt text](img4/image2.png)

```
Nos aseguramos que tenemos bien los datos de la configuracion.
```
![alt text](img4/image3.png)

# Practica 2

![alt text](img4/image4.png)
...
```
- Que es mas comodo y lo entindes mejor porque lo has echo tu y lo malo es que tienes que hacerlo tu y te lleva mucho tiempo.

-Montar una api para que la consuma una pagina web.

- El ejercicio 5 que lo tenia que hacer yo y entenderlo.Que puedo crear mis propias herramientas.
